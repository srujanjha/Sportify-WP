...
{
    public class NdtvViewModel : ViewModelBase<RssSchema>
    {
        override protected string CacheKey
        {
            get { return "NdtvDataSource"; }
        }

        override protected IDataSource<RssSchema> CreateDataSource()
        {
            return new NdtvDataSource(); // RssDataSource
        }
        ...
        {
            base.PinToStart("NdtvDetail", "{Title}", "{Summary}", "{ImageUrl}");
        }
        ...
        {
            NavigationServices.NavigateToPage("NdtvList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("NdtvDetail");
        }
    }
}

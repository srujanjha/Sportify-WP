...
{
    public class IndiaTodayViewModel : ViewModelBase<RssSchema>
    {
        override protected string CacheKey
        {
            get { return "IndiaTodayDataSource"; }
        }

        override protected IDataSource<RssSchema> CreateDataSource()
        {
            return new IndiaTodayDataSource(); // RssDataSource
        }
        ...
        {
            base.PinToStart("IndiaTodayDetail", "{Title}", "{Summary}", "{ImageUrl}");
        }
        ...
        {
            NavigationServices.NavigateToPage("IndiaTodayList");
        }

        override protected void NavigateToSelectedItem()
        {
            NavigationServices.NavigateToPage("IndiaTodayDetail");
        }
    }
}
